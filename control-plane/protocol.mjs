...
export const TASK_TRANSITIONS = Object.freeze({
  draft: ["ready"],
  ready: ["running", "waiting", "canceled", "discarded"],
  running: ["waiting", "verifying", "blocked", "failed", "canceled", "discarded"],
  waiting: ["running", "verifying", "blocked", "failed", "canceled", "discarded"],
  verifying: ["review_ready", "blocked", "failed", "canceled", "discarded"],
  blocked: ["running", "waiting", "failed", "canceled", "discarded"],
  review_ready: [
    "accepted",
    "changes_requested",
    "rejected",
  ...
  changes_requested: ["running", "waiting", "canceled", "discarded"],
