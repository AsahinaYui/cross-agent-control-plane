...
```powershell
docker pull ghcr.io/asahinayui/cross-agent-control-plane:1.10.0 # x-release-please-version
...
docker run -it --rm `
  ...
  ghcr.io/asahinayui/cross-agent-control-plane:1.10.0 # x-release-please-version
```
